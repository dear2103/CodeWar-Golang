...
Terminal game move function. In this game, the hero moves from left to right. The player rolls the die and moves the number of spaces indicated by the die two times. Create a function for the terminal game that takes the current position of the hero and the roll (1-6) and return the new position.
> Example:
...
## Ex21 
  [Multiples of 3 or 5 <6kyu>](https://github.com/dear2103/CodeWar-Golang/blob/main/MultiplesOf3Or5.go)
  If we list all the natural numbers below 10 that are multiples of 3 or 5, we get 3, 5, 6 and 9. The sum of these multiples is 23. Finish the solution so that it returns the sum of all the multiples of 3 or 5 below the number passed in.
> Note: If the number is a multiple of both 3 and 5, only count it once. Also, if a number is negative, return 0(for languages that do have them)
Courtesy of projecteuler.net
  ## Ex22
  [Find the odd int <6kyu>](https://github.com/dear2103/CodeWar-Golang/blob/main/FindTheOddInt.go)
  Given an array of integers, find the one that appears an odd number of times. There will always be only one integer that appears an odd number of times.
## Ex23
  [Split Strings <6kyu>](https://github.com/dear2103/CodeWar-Golang/blob/main/SplitStrings.go)
...
- Solution("abcdef") //should return ["ab", "cd", "ef"]
  ## Ex24
  [IP Validation <6kyu>](https://github.com/dear2103/CodeWar-Golang/blob/main/IPValidation.go)
...
- Inputs are guaranteed to be a single string
  ## Ex25
  [ISBN-10 Validation <5kyu>](https://github.com/dear2103/CodeWar-Golang/blob/main/ISBN-10Validation.go)
